...
<head>
  ...
  <title>Insurance Portal Login — Fastrux Logistics</title>
...
<body>
  ...
  <header class="header">
    <div class="container header-content">
      ...
      <div class="header-actions">
        ...
        <a class="btn btn-primary" href="register?role=insurance_company">Join as Insurer</a>
      </div>
  ...
  <div class="auth-wrapper" style="align-items:flex-start;padding-top:48px;">
    <div style="width:100%;max-width:460px;margin:0 auto;">
      ...
      <div class="auth-card" style="margin-bottom:20px;">
        ...
        <h1 class="auth-title">Insurance Partner Login</h1>
        <p class="auth-subtitle">Sign in to manage your spot insurance offerings on the Fastrux Marketplace.</p>

        <div class="form-feedback" id="loginFeedback"></div>
        <form id="loginForm" novalidate>
          <input type="hidden" name="form_type" value="login" />
          <input type="hidden" name="expected_role" value="insurance_company" />
          <div class="form-group">
            <label for="email">Company Email</label>
            <input class="form-control" type="email" id="email" name="email"
                   placeholder="insurer@company.com" required autocomplete="email" />
          </div>
          <div class="form-group">
            <label for="password">
              Password
        ...
        <p class="auth-footer-text">Don't have an account? <a href="register">Register as an insurance company</a></p>
        <p class="auth-footer-text" style="font-size:13px;color:var(--muted-foreground);">
          Not an insurance company? <a href="login">General login</a>
        </p>
      </div>

      <!-- Features card -->
      <div class="auth-card" style="padding:24px;">
        <h2 style="font-size:16px;font-weight:700;margin-bottom:4px;">What you can do with the Insurance Portal</h2>
        <p style="font-size:13px;color:var(--muted-foreground);margin-bottom:0;">Connect directly with trucking companies and owner-operators who need coverage.</p>
        <div class="features-list">
          <div class="feature-tile">
            <iconify-icon icon="lucide:file-plus"></iconify-icon>
            <span class="ft-title">Post Spot Insurance</span>
            <span class="ft-desc">Publish cargo, liability, and specialty coverage offerings instantly.</span>
          </div>
          <div class="feature-tile">
            <iconify-icon icon="lucide:users"></iconify-icon>
            <span class="ft-title">Reach Carriers</span>
            <span class="ft-desc">Your listings are visible to all Fastrux carriers and drivers.</span>
          </div>
          <div class="feature-tile">
            <iconify-icon icon="lucide:bar-chart-2"></iconify-icon>
            <span class="ft-title">Track Performance</span>
            <span class="ft-desc">View impressions, inquiries, and listing analytics.</span>
          </div>
          <div class="feature-tile">
            <iconify-icon icon="lucide:zap"></iconify-icon>
            <span class="ft-title">Real-Time Updates</span>
            <span class="ft-desc">Update coverage terms, rates, and availability on the fly.</span>
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    // Pre-fill role from URL query param
    ...
    document.getElementById('loginForm').addEventListener('submit', async function(e) {
      ...
      try {
        ...
        if (data.success) {
          ...
          // Enforce portal — only insurance companies may use this page
          if (role !== 'insurance_company') {
            feedback.className   = 'form-feedback error';
            feedback.textContent = '✗ This portal is for insurance companies only. Please use the general login page.';
          ...
          const redirect = params.get('redirect') || 'insurance-dashboard.php';
