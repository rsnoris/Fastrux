  ...
  <header class="header">
    <div class="container header-content">
      ...
      <div class="header-actions">
        ...
        <a class="btn btn-primary" href="register?role=gas_station">List Your Station</a>
      </div>
  ...
  <div class="auth-wrapper" style="align-items:flex-start;padding-top:48px;">
    <div style="width:100%;max-width:460px;margin:0 auto;">
      ...
      <div class="auth-card" style="margin-bottom:20px;">
        ...
        <p class="auth-footer-text">Don't have an account? <a href="register?role=gas_station">Register your gas station</a></p>
        <p class="auth-footer-text" style="font-size:13px;color:var(--muted-foreground);">
          Not a gas station? <a href="login">General login</a>
        </p>
      </div>
