  ...
  <header class="dash-header">
    <div class="container dash-header-inner">
      ...
      <div style="display:flex;align-items:center;gap:10px;">
        ...
        <a href="driver-dashboard.html" class="btn btn-outline" style="padding:8px 14px;font-size:13px;">
          <iconify-icon icon="lucide:users" style="font-size:15px;margin-right:6px"></iconify-icon>
          Drivers
        </a>
        <a href="driver-location.html" class="btn btn-outline" style="padding:8px 14px;font-size:13px;">
          <iconify-icon icon="lucide:locate" style="font-size:15px;margin-right:6px"></iconify-icon>
          My Location
        </a>
        <a href="index.html" class="btn btn-primary" style="padding:8px 14px;font-size:13px;">
