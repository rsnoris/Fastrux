...
<head>
  ...
  <title>Fastrux — Global Logistics &amp; Freight Management</title>
...
<body>
    ...
    <div class="container hero-grid">
      <div class="hero-content">
        ...
        <div class="hero-actions">
          <a class="btn btn-primary" href="track">Track Shipment</a>
          <a class="btn btn-outline" href="#services">Explore Services</a>
        </div>
      </div>
      <div class="hero-image-wrapper">
        <img
          src="https://storage.googleapis.com/banani-generated-images/generated-images/0c688d44-ce80-4899-8c77-1fc778ceae20.jpg"
          alt="Modern logistics truck driving on highway at sunset"
          loading="eager"
        />
      </div>
    </div>
  ...
  <section class="section section-alt" id="services">
    <div class="container">
      <h2 class="section-title">Comprehensive Logistics Solutions</h2>
      ...
      <div class="services-grid">
        <div class="service-card">
          ...
          <a class="service-link" href="ocean-freight">Learn more <iconify-icon icon="lucide:arrow-right" style="font-size:16px"></iconify-icon></a>
        </div>
        <div class="service-card">
          ...
          <a class="service-link" href="air-freight">Learn more <iconify-icon icon="lucide:arrow-right" style="font-size:16px"></iconify-icon></a>
        </div>
        <div class="service-card">
          ...
          <a class="service-link" href="ground-transport">Learn more <iconify-icon icon="lucide:arrow-right" style="font-size:16px"></iconify-icon></a>
        </div>
        <div class="service-card">
          ...
          <a class="service-link" href="warehousing">Learn more <iconify-icon icon="lucide:arrow-right" style="font-size:16px"></iconify-icon></a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="tracking-section" id="tracking">
    <div class="container tracking-container">
      ...
      <form class="tracking-form" action="track" method="GET">
  ...
  <section class="section">
    <div class="container">
      <h2 class="section-title">Why Businesses Choose Fastrux</h2>
      <p class="section-subtitle">Two decades of logistics expertise, technology-powered, people-driven.</p>
      <div class="stats-strip">
        <div class="stat-item"><h3>20+</h3><p>Years in operation</p></div>
        <div class="stat-item"><h3>180+</h3><p>Countries served</p></div>
        <div class="stat-item"><h3>4.2M</h3><p>Shipments delivered</p></div>
        <div class="stat-item"><h3>98.7%</h3><p>On-time delivery rate</p></div>
      </div>
    </div>
  </section>
    ...
    <div class="container home-contact-grid">
      <div class="home-contact-info">
        ...
        <div style="margin-top:32px;display:flex;gap:12px;flex-wrap:wrap;">
          ...
          <a class="btn btn-outline" href="contact">Full Contact Page</a>
        </div>
      </div>
      ...
      <div class="contact-form-card">
        ...
        <form id="homeContactForm" novalidate>
          ...
          <div class="form-group">
            <label for="hc_email">Email Address *</label>
            <input class="form-control" type="email" id="hc_email" name="email" placeholder="you@company.com" required />
          </div>
          <div class="form-group">
            <label for="hc_phone">Phone Number</label>
            <input class="form-control" type="tel" id="hc_phone" name="phone" placeholder="+1 (555) 000-0000" />
          </div>
          <div class="form-group">
            <label for="hc_subject">Subject *</label>
            <select class="form-control" id="hc_subject" name="subject" required>
          ...
          <div class="form-group">
            <label for="hc_message">Message *</label>
            <textarea class="form-control" id="hc_message" name="message" rows="4"
                      placeholder="Tell us how we can help…" required style="resize:vertical;"></textarea>
          </div>
          <button type="submit" class="btn btn-primary" id="homeContactBtn"
