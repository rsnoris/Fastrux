...
<head>
  ...
  <title>Privacy Policy — Fastrux Logistics</title>
  ...
  <style>
    ...
    .legal-hero h1 { font-size: 38px; font-weight: 800; margin-bottom: 8px; }
    ...
    .legal-body h2 {
      font-size: 22px; font-weight: 700; margin: 40px 0 12px; color: var(--foreground);
    }
    .legal-body h2:first-child { margin-top: 0; }
    .legal-body p, .legal-body li {
      font-size: 15px; line-height: 1.8; color: var(--muted-foreground); margin-bottom: 12px;
    }
  ...
  <section class="section">
    <div class="container">
      <div class="legal-body">
        ...
        <p>
          Fastrux Logistics ("Fastrux", "we", "our", or "us") is committed to protecting your personal information.
          This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use
          our website, services, or interact with us in any way.
        </p>

        <h2>2. Information We Collect</h2>
        <p>We may collect the following categories of personal information:</p>
        <ul>
          <li><strong>Identity data:</strong> first name, last name, company name, title.</li>
          <li><strong>Contact data:</strong> email address, telephone number, billing and delivery address.</li>
          <li><strong>Shipment data:</strong> tracking numbers, cargo descriptions, origin and destination details.</li>
          <li><strong>Account data:</strong> username, password (hashed), account preferences.</li>
          <li><strong>Technical data:</strong> IP address, browser type, device identifiers, cookies, and usage data.</li>
          <li><strong>Financial data:</strong> payment card details (processed securely via third-party providers).</li>
        </ul>

        <h2>3. How We Use Your Information</h2>
        <p>We use your personal information to:</p>
        <ul>
          <li>Process and manage your shipments and logistics orders.</li>
          <li>Create and manage your Fastrux account.</li>
          <li>Send transactional communications including booking confirmations and tracking updates.</li>
        ...
        <p>
          We process personal data on the following legal bases: performance of a contract with you, compliance
          with a legal obligation, our legitimate business interests, and your consent where applicable.
        </p>
        ...
        <ul>
          <li>Carrier partners and customs authorities necessary to fulfill your shipment.</li>
          <li>Service providers who assist us in operating our business (e.g., payment processors, IT providers).</li>
          <li>Regulatory or law enforcement bodies when required by law.</li>
        </ul>

        <h2>6. Data Retention</h2>
        <p>
          We retain your personal data for as long as necessary to provide our services and comply with
          legal obligations. Shipment records are retained for a minimum of 7 years in accordance with
        ...
        <p>
          To exercise these rights, please contact us at <a href="mailto:privacy@fastrux.com">privacy@fastrux.com</a>.
        </p>

        <h2>8. Cookies</h2>
        <p>
          Our website uses cookies to improve your browsing experience, analyse site traffic, and personalise
          content. You can control cookie settings through your browser preferences. Disabling cookies may
        ...
        <p>
          ...
          accidental loss, unauthorised access, disclosure, alteration, or destruction. However, no internet
          transmission is completely secure and we cannot guarantee absolute security.
        </p>

        <h2>10. International Transfers</h2>
        <p>
          As a global logistics company, your data may be transferred to and processed in countries outside
          your own. We ensure adequate safeguards are in place for such transfers in accordance with applicable
        ...
        <h2>12. Contact Us</h2>
        <p>
          If you have any questions about this Privacy Policy, please contact our Data Privacy team at:
        </p>
        <p>
          <strong>Fastrux Logistics</strong><br>
          1008 Oak Chase way, Leander, TX 78641<br>
          Email: <a href="mailto:privacy@fastrux.com">privacy@fastrux.com</a><br>
          Phone: <a href="tel:+2038896129">+203-889-6129</a>
        </p>
