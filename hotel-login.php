...
<head>
  ...
  <title>Hotel Portal Login — Fastrux Logistics</title>
  ...
  <style>
    ...
    .portal-badge {
      ...
      color: #6b21a8; border-radius: 20px;
  ...
  <div class="auth-wrapper" style="align-items:flex-start;padding-top:48px;">
    <div style="width:100%;max-width:460px;margin:0 auto;">
      ...
      <div class="auth-card" style="margin-bottom:20px;">
        ...
        <h1 class="auth-title">Hotel Partner Login</h1>
        <p class="auth-subtitle">Sign in to manage your hotel and lodging listings on the Fastrux Marketplace.</p>

        <div class="form-feedback" id="loginFeedback"></div>
        <form id="loginForm" novalidate>
          <input type="hidden" name="form_type" value="login" />
          <input type="hidden" name="expected_role" value="hotel" />
          <div class="form-group">
            <label for="email">Hotel Email</label>
            <input class="form-control" type="email" id="email" name="email"
                   placeholder="contact@hotel.com" required autocomplete="email" />
          </div>
          <div class="form-group">
            <label for="password">
              Password
      ...
      <div class="auth-card" style="padding:24px;">
        <h2 style="font-size:16px;font-weight:700;margin-bottom:4px;">What you can do with the Hotel Portal</h2>
        <p style="font-size:13px;color:var(--muted-foreground);margin-bottom:0;">Attract truckers and logistics professionals looking for rest stops and overnight stays along their routes.</p>
        <div class="features-list">
          <div class="feature-tile">
            <iconify-icon icon="lucide:hotel"></iconify-icon>
            <span class="ft-title">List Your Property</span>
            <span class="ft-desc">Post rooms, rates, and amenities to reach drivers and logistics teams.</span>
          </div>
          <div class="feature-tile">
            <iconify-icon icon="lucide:truck"></iconify-icon>
            <span class="ft-title">Truck-Friendly Stays</span>
            <span class="ft-desc">Highlight truck parking, 24-hour check-in, and driver-friendly facilities.</span>
          </div>
          <div class="feature-tile">
            <iconify-icon icon="lucide:edit-3"></iconify-icon>
            <span class="ft-title">Manage Listings</span>
            <span class="ft-desc">Update prices, availability, and amenity details at any time.</span>
          </div>
          <div class="feature-tile">
            <iconify-icon icon="lucide:users"></iconify-icon>
            <span class="ft-title">Reach Drivers</span>
            <span class="ft-desc">Your property is visible to the entire Fastrux driver and carrier network.</span>
          </div>
        </div>
      </div>
      ...
      try {
        ...
        if (data.success) {
          ...
          if (role !== 'hotel') {
            ...
            feedback.textContent = '✗ This portal is for hotel partners only. Please use the general login page.';
          ...
          const redirect = params.get('redirect') || 'hotel-dashboard.php';
